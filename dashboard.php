...
<nav class="navbar navbar-inverse">
  ...
  <table class="table table-bordered table-striped">
    ...
    if (isset($_GET["pencarian"])) {
      ...
      $query = mysqli_query($koneksi, "SELECT CONCAT(nama_depan,' ',nama_belakang) AS 'Nama Lengkap', nim, kelas, hobi, genre_film, tempat_wisata, tanggal_lahir, gambar FROM data WHERE nim LIKE '%".$nim."%'");
    } else{
    ...
    <tbody>
      <tr>
        ...
        <td><a href="info.php?nim=<?php echo $data["nim"] ?>"><button type="button" class="btn btn-info">Info</button></a></td>
      </tr>
    </tbody>
  <?php } ?>
  </table> 
